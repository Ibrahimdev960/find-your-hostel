...
export function ReportButton({
  ...
  if (!open) {
    return (
      <button
        ...
        className="inline-flex items-center gap-1 text-xs text-neutral-400 hover:text-danger"
      >
  ...
  return (
    <div className="mt-2 space-y-2 rounded-md border border-neutral-200 p-2">
      <Textarea
        value={reason}
